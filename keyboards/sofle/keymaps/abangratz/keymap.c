...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        /* second line */
        XXXXXXX, KC_EXLM, KC_AT, KC_SLSH, KC_BSLS, KC_TILD, KC_RPRN, KC_7, KC_8, KC_9, KC_KP_MINUS, _______,
        /* third line */
        XXXXXXX, KC_LBRC, KC_RBRC, MO(_RAISE), KC_LSFT, KC_PLUS, KC_LPRN, RSFT_T(KC_4), KC_5, KC_6, KC_KP_PLUS, XXXXXXX,
        /* fourth line */
